 ...
 * @stamp {"utc":"2026-04-19T09:00:00.000Z"}
 * @architectural-role Pure Logic (Technical Data Processor)
 * @description
 * Pure functions for managing technical API Blueprints. 
 * Implements validation logic for raw JSON and "scrubbing" logic to translate 
 * UI descriptors into flat API payloads.
 * 
 * @api-declaration
 ...
 * 
 * @param {string} jsonString - The raw string from the JSON editor.
...
export function isValidBlueprint(jsonString) {
    ...
    try {
        ...
        // Basic sanity check: each key should probably have a 'type' or be an object
...
export function scrubEngineParams(blueprint, userValues = {}) {
    ...
    for (const [key, descriptor] of Object.entries(spec)) {
        ...
        // (UI inputs like range sliders often return strings)
